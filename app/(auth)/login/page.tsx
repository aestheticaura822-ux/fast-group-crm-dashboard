    ...
    <div className="min-h-screen bg-gradient-to-br from-[#C41E3A] to-[#8B1528] flex items-center justify-center p-4">
      <div className="w-full max-w-md px-3 sm:px-4">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-xs sm:text-sm text-white/70">Welcome back! Please login to continue</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            {error && (
              <div className="bg-red-50 text-red-600 p-2 sm:p-3 rounded-lg text-[10px] sm:text-xs border-l-4 border-red-500">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@fastgroup.com"
                required
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="w-3 h-3 sm:w-4 sm:h-4 border-gray-300 rounded text-[#C41E3A] focus:ring-[#C41E3A]"
                />
